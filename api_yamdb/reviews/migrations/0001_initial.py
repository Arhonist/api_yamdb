# Generated by Django 3.2 on 2023-01-02 09:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(default=5, validators=[django.core.validators.MinValueValidator(1, 'Оценка должна быть >=1'), django.core.validators.MaxValueValidator(10, 'Оценка должна быть <= 10')])),
        ...
        migrations.AddConstraint(
            model_name='review',
            constraint=models.UniqueConstraint(fields=('title', 'author'), name='review-author'),
        ),
    ]
